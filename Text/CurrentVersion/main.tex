...
\begin{table}[htbp]
	\begin{center}\scalebox{1}{%\tabcolsep=0.11cm
			\begin{tabular}{lccc}
				\toprule
				názov metódy &  sto opakovaní (s) & CPU (\%) & RAM (MB) 
				\tabularnewline
				\midrule
				generateRequest & 85  & 30 & 10 \tabularnewline
				
				exportPKCS12 & 12 & 45 & 12 \tabularnewline
				sign   & 28 & 35 & 14 \tabularnewline
				listCertitficate  & 18 & 39 & 12  \tabularnewline
				listAllCertificates & 17 & 31 & 13\tabularnewline
				checkPassword & 10 &41 & 16\tabularnewline
				Sekvencia 1 & 17 & 50 & 13\tabularnewline
				Sekvencia 2 & 19 & 42 & 13\tabularnewline
				Sekvencia 3 & 15 & 49 & 12\tabularnewline
				\bottomrule
...
\begin{table}[htbp]
	\begin{center}\scalebox{1}{%\tabcolsep=0.11cm
			\begin{tabular}{lccc}
				\toprule
				názov metódy &  tisíc opakovaní (s) & CPU (\%) & RAM (MB) 
				\tabularnewline
				\midrule
				generateRequest & 843  & 29 & 15  \tabularnewline				
				exportPKCS12 & 110 & 44 & 19 \tabularnewline
				sign   & 187 & 35 & 20 \tabularnewline
				listCertitficate  & 196 & 39 & 12 \tabularnewline
				listAllCertificates & 243 & 31 & 13 \tabularnewline
				checkPassword & 94 & 41 & 17 \tabularnewline
				Sekvencia 1 & 154 & 47 & 13 \tabularnewline
				Sekvencia 2 & 180 & 38 & 24 \tabularnewline
				Sekvencia 3 & 120 & 42 & 24 \tabularnewline
				\bottomrule
