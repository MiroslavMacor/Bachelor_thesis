...
\begin{table}[htbp]
	\begin{center}\scalebox{1}{%\tabcolsep=0.11cm
			\begin{tabular}{lcc}
				...
				\tabularnewline
				\midrule
				generateRequest & 85  / 30 / 10& 868\tabularnewline
				
				exportPKCS12 & 12 / 45 / 12 & 95\tabularnewline
				sign   & 28 / 35 / 14 & 182\tabularnewline
				listCertitficate  & 18 / 39 / 12 & 95\tabularnewline
				listAllCertificates & 17 / 31 / 13 & 96\tabularnewline
				checkPassword & 10 /41 / 16 & 100\tabularnewline
				Sekvencia 1 & 17 / 50 / 13 & 132\tabularnewline
				Sekvencia 2 & 15 / 49 / 13 & 98\tabularnewline
				Sekvencia 3 & 11 /42 / 12& 104\tabularnewline
				\bottomrule
